...
if ($row = mysql_fetch_array($sql)) {
    ...
    $lng_idcomentario = $row['lng_idcomentario'];
    $marca = $row['marca'];
    $modelo = $row['modelo'];
...
<div class="panel panel-default">
    ...
    <div class="panel-heading" style="text-transform: none;"> <i class="fa fa-fw fa-comments"></i>&nbsp; Eliminar Comentario</div>
    <div class="panel-body">
        ...
        <input type="hidden" id="accion" name="accion" value="form_deletecomentario" readonly="yes">
    <input type="hidden" id="lng_idcomentario" name="lng_idcomentario" value="<?= $lng_idcomentario ?>" readonly="yes">
</form>