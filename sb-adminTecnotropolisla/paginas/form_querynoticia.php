...
<div class="panel panel-default">
    ...
    <div class="panel-heading" style="text-transform: none;"> <i class="fa fa-fw fa-coffee"></i>&nbsp; Consultar Noticia</div>
    <div class="panel-body">
        ...
        <div class="tab-content">
            ...
            <div class="form-inline" role="form">
                ...
                <div class="form-group">
                    <div class="col-sm-5">
                        <button type="button" onclick="url('form_searchnoticia.php')" class="btn btn-success">Cerrar</button>
                    </div>
                </div>
