...
<div class="panel panel-default">
    ...
    <div class="panel-heading" style="text-transform: none;"><i class="fa fa-fw fa-users"></i>&nbsp; Consultar Usuario</div>
            ...
            <div class="form-group">
                <div class="col-sm-5">
                    ...
                    <?php if ($_SESSION['rol'] == "Administrador") { ?> 
                        <button type="button" onclick="url('form_searchusuario.php')" class="btn btn-success">Cerrar</button>
                    <?php } else { ?>
                        <button type="button" onclick="window.location.href='inicio.php'" class="btn btn-success">Cerrar</button>   
                    <?php } ?>
                </div>
            </div>
